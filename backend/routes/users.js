...
router.patch('/updateuser', (req, res) => {
    ...
    User.findOne(body, async (err, user) => {
        ...
        if (req.body.email) { //TODO add email validator
            ...
            var tempAccessToken = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IlF6UTFPVVpGTTBRNFFUVTFRa1UyTmpJM05qQXpRMEpFUWpSR1JqZEJSRGhDTVRjeE5UZ3pSQSJ9..of-UheDnv_RRw8BxjK4vEZeo5BG2Sd9aOS-plGsEe14WkTCLPHz4GG5xVbX8jSXmaH7EEPDEz1hlYhVdvt8eDmCiCYV32KSqrRr6EAhhFNwosXTYGVAgFadbZddHeUgjOMDuKmu9uu7X8Q9y_lyT1Q-xB4HJg88fUsZwaYonUJ8yUz2_-GE0PoOvVeRdk8pfSkcNkj-mYLUjQdPQ3T9_nbBMSft3webweAEvRNYNu5iF0fgNYioq6YPVNtA_kkxwx0o6rjTW_fwaWR1JGL--SeDBmOzdhiBcGYVQJMdG-YLFmF-hy0MGehsS7wHHfcxkmwiX_kM8Y3y3ya49-dmTxg";
            await axios({
              method: 'PATCH',
