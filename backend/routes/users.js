...
router.patch('/updateuser', (req, res) => {
    ...
    User.findOne(body, async (err, user) => {
        ...
        if (req.body.email) { //TODO add email validator
            ...
            /*await axios({
              method: 'POST',
              url: `https://dev-s68c-q-y.auth0.com/oauth/token`,
              headers: {
              ...
              form: {
                ...
                client_secret: 'dISp7JkASwmzJKP-Cdg8i9d4es7KifGyYaHdY2_vNQraDGJLOgx9JX2k1Bvdfxie',
                audience: 'https://dev-s68c-q-y.auth0.com/api/v2/'
              }
            })
            .then( async (result) => {*/
